'use client';
// src/app/(public)/privacy-policy/PrivacyClient.jsx
// This is the interactive accordion UI — kept as a Client Component
// because it uses useState for toggling sections.
...
export default function PrivacyClient() {
  ...
  const sections = [
      ...
      content: (
        <>
          ...
          <p className="mt-2">
            ...
            <a href="mailto:privacy@akbartaxstore.com" className="text-[#0040A8] hover:underline">
              📧 privacy@akbartaxstore.com
            </a>
          </p>
        </>
      ),
    ...
    },
    {
      ...
      content: (
        <>
          <p>If you have any questions, concerns, or requests regarding your privacy, please contact us at:</p>
          <ul className="mt-2 space-y-1">
            <li>
              <a href="mailto:info@akbartaxstore.com" className="text-[#0040A8] hover:underline">
                📧 info@akbartaxstore.com
              </a>
            </li>
            <li>📞 +92 301-6832064</li>
            <li>
              🏢 Office Address: 348 E5 Street, Topaz Block, Park View City Multan Road
              <br />
              Lahore, Pakistan
            </li>
          </ul>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="bg-[#072971] p-6 text-white">
            ...
            <div className="mt-2 text-[#D9E8FF]">
              ...
              <p>
                Website:{' '}
                <a href="https://www.akbartaxstore.com" className="hover:underline">
                  www.akbartaxstore.com
                </a>
              </p>
          ...
          <div className="p-6">
            <div className="space-y-4">
              {sections.map((section) => (
                <div
                  key={section.id}
                  className="border-b border-[#D9E8FF] last:border-0 pb-4 last:pb-0"
                >
                  <button
                  ...
                  >
                    ...
                    <svg
                      className={`w-5 h-5 text-[#0040A8] transition-transform duration-200 ${
                  ...
                  <div
                    className={`mt-2 text-gray-700 leading-relaxed overflow-hidden transition-all duration-300 ${
                      openSections[section.id] ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0'
                    }`}
                  >
