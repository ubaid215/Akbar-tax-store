...
export async function generateStaticParams() {
  return BUSINESS_SERVICES.map((s) => ({ serviceId: s.id }));
}
...
export default async function BusinessServiceDetailPage({ params }) {
  ...
  const related = BUSINESS_SERVICES.filter((s) => s.id !== serviceId).slice(0, 3);
      ...
      <div className="min-h-screen bg-[#D9E8FF]">
        ...
        <section className="relative bg-gradient-to-r from-[#072971] to-[#0040A8] text-white py-16">
          <div className="container mx-auto px-6">
            <Link href="/business" className="inline-flex items-center text-[#D9E8FF] hover:text-white mb-6 text-sm">
                  ...
                  <div className="bg-[#D9E8FF] rounded-lg p-6 sticky top-24">
                    ...
                    <div className="pt-5 border-t border-[#0040A8]/30">
                      ...
                      <div className="space-y-2">
                        <a href={SITE_CONFIG.phoneTel} className="flex items-center text-sm text-[#050505] hover:text-[#0040A8] transition-colors">
                        ...
                        <a href={`mailto:${SITE_CONFIG.email}`} className="flex items-center text-sm text-[#050505] hover:text-[#0040A8] transition-colors">
                          <svg className="h-4 w-4 text-[#0040A8] mr-2 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
