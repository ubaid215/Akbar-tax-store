    ...
    <div className="space-y-8">
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          ...
          <label className="space-y-1"><span className="text-sm">Mode</span><select value={mode} onChange={(e) => setMode(e.target.value as "exclusive" | "inclusive")} className="min-h-11 w-full rounded-lg border px-3"><option value="exclusive">Tax already excluded</option><option value="inclusive">Tax already included</option></select></label>
